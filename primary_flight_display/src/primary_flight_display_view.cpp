...
{
    m_gridLayout->addWidget(m_headingIndicator, 0, 1, 1,
                            5); // NOLINT(cppcoreguidelines-avoid-magic-numbers)
    m_gridLayout->addWidget(m_speedIndicator, 1, 0, 7,
                            1); // NOLINT(cppcoreguidelines-avoid-magic-numbers)
    m_gridLayout->addWidget(m_attitudeIndicator, 2, 2, 5,
                            3); // NOLINT(cppcoreguidelines-avoid-magic-numbers)
    m_gridLayout->addWidget(m_altitudeIndicator, 1, 6, 7,
                            1); // NOLINT(cppcoreguidelines-avoid-magic-numbers)
