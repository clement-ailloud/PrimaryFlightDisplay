...
//    std::unique_ptr<View::AirspeedIndicator> indicatorView = make_unique<View::AirspeedIndicator>();
    View::AirspeedIndicator* indicatorView = new View::AirspeedIndicator();


//    std::unique_ptr<Model::AirspeedIndicator> indicatorModel = make_unique<Model::AirspeedIndicator>();
